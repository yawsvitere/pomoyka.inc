...
const CreatePostPage = lazy(() =>
  import("./pages/CreatePostPage").then(({ CreatePostPage }) => ({ default: CreatePostPage })),
);
const EditPostishkaPage = lazy(() =>
  import("./pages/EditPostishkaPage").then(({ EditPostishkaPage }) => ({ default: EditPostishkaPage })),
);
const PostishkiPage = lazy(() =>
  import("./pages/PostishkiPage").then(({ PostishkiPage }) => ({ default: PostishkiPage })),
);
const ArticlePage = lazy(() =>
  import("./pages/ArticlePage").then(({ ArticlePage }) => ({ default: ArticlePage })),
);
const ArchiveCalendarPage = lazy(() =>
  import("./pages/ArchiveCalendarPage").then(({ ArchiveCalendarPage }) => ({ default: ArchiveCalendarPage })),
);
const ArchivePage = lazy(() =>
  import("./pages/ArchivePage").then(({ ArchivePage }) => ({ default: ArchivePage })),
);
const FileManagerPage = lazy(() =>
  import("./pages/FileManagerPage").then(({ FileManagerPage }) => ({ default: FileManagerPage })),
);
const FileGalleryPage = lazy(() =>
  import("./pages/FileGalleryPage").then(({ FileGalleryPage }) => ({ default: FileGalleryPage })),
);
const FileSharePage = lazy(() =>
  import("./pages/FileSharePage").then(({ FileSharePage }) => ({ default: FileSharePage })),
);
const PinterestPage = lazy(() =>
  import("./pages/PinterestPage").then(({ PinterestPage }) => ({ default: PinterestPage })),
);
const PrivateLayout = lazy(() =>
  import("./components/layout/PrivateLayout").then(({ PrivateLayout }) => ({ default: PrivateLayout })),
);
